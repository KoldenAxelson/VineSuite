...
class StoreDryGoodsItemRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'item_type' => ['required', 'string', Rule::in(DryGoodsItem::ITEM_TYPES)],
            'unit_of_measure' => ['required', 'string', Rule::in(DryGoodsItem::UNITS_OF_MEASURE)],
