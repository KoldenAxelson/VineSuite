...
class TTBSectionALinesWidget extends TableWidget
{
    protected static bool $isDiscovered = false;

    protected static ?string $heading = 'Section A — Bulk Wine Line Items';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateDescription('No activity in Section A for the reporting period.')
