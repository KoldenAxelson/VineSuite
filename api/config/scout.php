...
return [
    ...
    */
    ...
    |
    | We prefix with tenant ID at runtime via the model's searchableAs() override.
    |
    */

    'prefix' => env('SCOUT_PREFIX', 'vinesuite_'),
    ...
    */
    ...
    | been committed, ensuring no orphaned data in your indexes.
    |
    */
